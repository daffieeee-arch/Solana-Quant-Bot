...
9. `docs/HERMES_REVIEW_REQUEST_REPO_ALIGNMENT_CI.md`
10. `docs/HERMES_REVIEW_RESPONSE_ROUND1.md`
11. `docs/HERMES_REVIEW_RESPONSE_ROUND2.md`
12. `docs/HERMES_REVIEW_RESPONSE_ROUND3.md`
13. `docs/triton-cost-safety.md`
14. `docs/offline-hardening-decimals-cost.md`
15. `docs/pump-source-classification.md`
16. `docs/protocol-coverage.md`
