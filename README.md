...
- Phase 8C implements an offline, unapplied cockpit-only runtime candidate, inert compiled/runtime graph gates, separate image/dataset/deployment contracts, a `LEGACY_FORENSIC_V1` Grafana archive and a new Grafana-as-Code suite. It deploys or starts nothing; see [`docs/PHASE8C_COCKPIT_ONLY_RUNTIME_GRAFANA_ARCHITECTURE.md`](docs/PHASE8C_COCKPIT_ONLY_RUNTIME_GRAFANA_ARCHITECTURE.md).
