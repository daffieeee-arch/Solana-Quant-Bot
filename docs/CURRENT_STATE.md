...
- Phase 8D stopped before mutation because Hermes has no container builder/runtime. Phase 8D1 is an uncommitted remote-builder candidate; GitHub-hosted image/container verification remains `NOT_EXECUTED_PENDING_DELIVERY`, no GHCR push occurred, and every TrueNAS/Grafana/ClickHouse/HOLD nonclaim remains unchanged.
