...
| PR 5 / B5 | **Next, partial offline preparation explicitly authorized:** [725 authentic transaction/status packages → Bronze JSON/report](research/B5_AUTHENTIC_RAW_BRONZE.md); Silver, coin lifecycle and physical Parquet writer remain outstanding |
