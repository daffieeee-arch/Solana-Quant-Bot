...
- **B4 offline remainder (not live B4B):** The first OF1 research memo and the next offline package contract are [`research/OF1_QUANT_RESEARCH_MEMO_V2.md`](research/OF1_QUANT_RESEARCH_MEMO_V2.md) and [`research/B4_OFFLINE_REMAINDER.md`](research/B4_OFFLINE_REMAINDER.md). They do not authorize a download, pin Jetstreamer, or complete B4. Live B4B stays reserved for a later separately approved lease.
