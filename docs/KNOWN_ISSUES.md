...
26. **Phase 8C deployment remains HOLD:** cockpit/runner base-image digests and dedicated UID/GID pairs are unresolved; the POSIX dataset and both TrueNAS apps are unapplied. The existing `solana-bot` app remains STOPPED.
