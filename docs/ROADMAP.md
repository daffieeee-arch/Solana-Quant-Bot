...
| PR 6 / B6 #85 | **Bounded engineering acceptance, subject to protected delivery:** interactive Research Observatory MVP | [Original criteria and evidence](research/B6_ENGINEERING_ACCEPTANCE_20260924.md): mint replay/reserves/flow and pilot-quality/operational presentation; source unknowns explicit | no fake panels, frozen-legacy extension, paper controls or full workbench |
