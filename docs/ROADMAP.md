...
> **Document status: ACTIVE.** [GitHub Project #4](https://github.com/users/daffieeee-arch/projects/4) is the central delivery roadmap. The owner accepted the [bounded B4/B5 engineering contracts on 2026-09-23](research/B4_B5_ENGINEERING_ACCEPTANCE_20260923.md). B4/#83 and B5/#84 are complete at `Engineering Validation`; B6/#85 is the current `ACTIVE NOW` item with one partial mint-inspector increment; #85 remains open / Unproven. Research Ready remains false. The completed migration ledger and historical source/lease evidence are preserved; no further acquisition is authorized.
...
| PR 6 / B6 #85 | **In Progress / ACTIVE NOW / Unproven; partial increment:** interactive Research Observatory MVP | First [read-only mint-package inspector](research/B6_LOCAL_MINT_INSPECTOR.md); remaining #85 requirements require separate scope and evidence | no fake panels, frozen-legacy extension, paper controls or full workbench |
