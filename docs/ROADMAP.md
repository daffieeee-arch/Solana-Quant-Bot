...
| PR 6 / B6 #85 | **In Progress / ACTIVE NOW / Unproven; partial increment:** interactive Research Observatory MVP | [Read-only mint-package inspector, presentation timeline/trade table, event reserve/address views and bounded pilot-quality view](research/B6_LOCAL_MINT_INSPECTOR.md); remaining #85 requirements require separate scope and evidence | no fake panels, frozen-legacy extension, paper controls or full workbench |
